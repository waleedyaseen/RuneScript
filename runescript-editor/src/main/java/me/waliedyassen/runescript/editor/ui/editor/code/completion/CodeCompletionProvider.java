...
public final class CodeCompletionProvider extends DefaultCompletionProvider {
     ...
     *
     * @param table the lexical table to grab the keywords from.
     */
     ...
     *
     * @param table the symbol table to grab the commands from.
     */
    private void refreshCommands(SymbolTable table) {
     ...
     *
     * @param all  a set of all the code completion objects.
